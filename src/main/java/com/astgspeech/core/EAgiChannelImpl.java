 ...
 * 
 * @author srt
 * @version $Id: EAgiChannelImpl.java 1271 2009-03-21 03:41:24Z srt $
 */
public class EAgiChannelImpl implements AgiChannel
{
    private final AgiRequest request;
    private final EAgiWriter agiWriter;
    private final EAgiReader agiReader;

    private AgiReply lastReply;

    EAgiChannelImpl(AgiRequest request, LineNumberReader socket)
    {
        this.request = request;
        this.agiWriter = new EAgiWriter();
        this.agiReader = new EAgiReader(socket);
        this.lastReply = null;
    }

    EAgiChannelImpl(AgiRequest request, EAgiWriter agiWriter, EAgiReader agiReader)
    {
        this.request = request;
