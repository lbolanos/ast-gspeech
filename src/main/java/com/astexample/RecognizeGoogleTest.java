 ...
 */
public class RecognizeGoogleTest {
  ...
  private static final Logger logger =
        Logger.getLogger(RecognizeGoogleTest.class.getName());
  ...
  public static void main(String[] args) throws Exception {
    ...
    RecognizeGoogleTest client =
        new RecognizeGoogleTest(host, port, audioFile, sampling);
    try {
      client.recognize();
    } finally {
      client.shutdown();
